...
{
    /// <summary>
    /// This is a dictionary guaranteed to have only one of each value and key. It may be searched
    /// either by TFirst or by TSecond, giving a unique answer because it is 1 to 1.
    /// </summary>
    ...
    public class BiDictionary<TFirst, TSecond>
    {
        ...
        public BiDictionary(IEnumerable<KeyValuePair<TFirst, TSecond>> inp)
        {
            foreach (var kvp in inp)
            {
        ...
        /// <summary>
        /// Tries to add the pair to the dictionary. Throws an exception if either element is already
        /// in the dictionary
        /// </summary>
        ...
        /// <summary>
        /// Find the TSecond corresponding to the TFirst first Throws an exception if first is not in
        /// the dictionary.
        /// </summary>
        ...
        /// <summary>
        /// Find the TFirst corresponing to the Second second. Throws an exception if second is not
        /// in the dictionary.
        /// </summary>
        ...
        /// <summary>
        /// Tries to add the pair to the dictionary. Returns false if either element is already in
        /// the dictionary
        /// </summary>
        /// <param name="first"></param>
        /// <param name="second"></param>
        ...
        /// <summary>
        /// Find the TFirst corresponding to the TSecond second. Returns false if second is not in
        /// the dictionary.
        /// </summary>
        /// <param name="second">the key to search for</param>
