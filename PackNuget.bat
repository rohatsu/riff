...
cd..
cd RIFF.Console
..\nuget pack RIFF.Console.csproj -IncludeReferencedProjects -Symbols -Version 2.2.11
cd..
cd RIFF.Framework
..\nuget pack RIFF.Framework.csproj -IncludeReferencedProjects -Symbols -Version 2.2.11
cd..
cd RIFF.Web.Core
..\nuget pack RIFF.Web.Core.csproj -IncludeReferencedProjects -Symbols -Version 2.2.11
..\nuget pack RIFF.Web.Core.nuspec -Version 2.2.11
cd ..
